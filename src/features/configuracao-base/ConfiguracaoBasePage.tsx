...
export function ConfiguracaoBasePage() {
  ...
  async function handleSave() {
    try {
      await mutate(form);
      toast.success("Configurações Base salvas com sucesso.");
    } catch (err) {
  ...
  return (
    <FormCard title="Configurações Base" icon={Settings} onSave={handleSave} loading={loading}>
